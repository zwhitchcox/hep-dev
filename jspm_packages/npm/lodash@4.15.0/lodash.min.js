...
(function(Buffer) {
  ...
  (function() {
    ...
    function u(t, n) {
      for (var r = -1,
          e = t ? t.length : 0; ++r < e && false !== n(t[r], r, t); )
        ;
      return t;
    }
    function o(t, n) {
 ...
 while (n);
      ...
      function sr(t, n, r) {
        var e = -1,
            u = t.length;
        for (0 > n && (n = -n > u ? 0 : u + n), r = r > u ? u : r, 0 > r && (r += u), u = n > r ? 0 : r - n >>> 0, n >>>= 0, r = Cu(u); ++e < u; )
          r[e] = t[e + n];
        return r;
      }
      function hr(t, n) {
      ...
      function Ur(t) {
        return ar(function(n, r) {
          ...
          for (i && de(r[0], r[1], i) && (o = 3 > u ? P : o, u = 1), n = Tu(n); ++e < u; )
            (i = r[e]) && t(n, i, e, o);
          return n;
        });
      }
      function Mr(t, n) {
        return function(r, e) {
          ...
          for (var u = r.length,
              o = n ? u : -1,
              i = Tu(r); (n ? o-- : ++o < u) && false !== e(i[o], o, i); )
            ;
          return r;
        };
      }
      ...
      function Tr(t) {
        return function(n) {
          ...
          var r = Ut.test(n) ? F(n) : P,
              e = r ? r[0] : n.charAt(0);
          return n = r ? kr(r, 1).join("") : n.slice(1), e[t]() + n;
        };
      }
      function $r(t) {
        return function(n) {
      ...
      function Zr(t) {
        return ar(function(n) {
          ...
          return function() {
            var t = arguments,
                e = t[0];
            if (i && 1 == t.length && Fi(e) && 200 <= e.length)
      ...
      function qr(t, n, r, e, u, o, i, f, c, a) {
        function l() {
          ...
          if (e && (y = Ir(y, e, u, _)), o && (y = Rr(y, o, i, _)), d -= x, _ && d < a)
            return j = z(y, j), Xr(t, n, qr, l.placeholder, r, y, j, f, c, a - d);
          if (j = h ? r : this, b = p ? j[t] : t, d = y.length, f) {
            x = y.length;
            for (var w = jo(f.length, x),
                m = Wr(y); w--; ) {
              var A = f[w];
              y[w] = ge(A, x) ? m[A] : P;
            }
      ...
      function Jr(t, n) {
        n = n === P ? " " : dr(n);
        var r = n.length;
        return 2 > r ? r ? cr(n, t) : n : (r = cr(n, ho(t / $(n))), Ut.test(n) ? kr(F(r), 0, t).join("") : r.slice(0, t));
      }
      function Yr(t, n, e, u) {
        function o() {
          for (var n = -1,
              ...
              l = u.length,
              s = Cu(l + c),
              h = this && this !== Vt && this instanceof o ? f : t; ++a < l; )
            s[a] = u[a];
          for (; c--; )
            s[a++] = arguments[++n];
      ...
      function re(t, n, r, e, u, o, i, f) {
        ...
        var h = c ? P : Yo(t);
        return o = [t, n, r, e, u, l, s, o, i, f], h && (r = o[1], t = h[1], n = r | t, e = 128 == t && 8 == r || 128 == t && 256 == r && o[7].length <= h[8] || 384 == t && h[7].length <= h[8] && 8 == r, 131 > n || e) && (1 & t && (o[2] = h[2], n |= 1 & r ? 0 : 4), (r = h[3]) && (e = o[3], o[3] = e ? Ir(e, r, h[4]) : r, o[4] = e ? z(o[3], "__lodash_placeholder__") : h[4]), (r = h[5]) && (e = o[5], o[5] = e ? Rr(e, r, h[6]) : r, o[6] = e ? z(o[5], "__lodash_placeholder__") : h[6]), (r = h[7]) && (o[7] = r), 128 & t && (o[8] = null == o[8] ? h[8] : jo(o[8], h[8])), null == o[9] && (o[9] = h[9]), o[0] = h[0], o[1] = n), t = o[0], n = o[1], r = o[2], e = o[3], u = o[4], f = o[9] = null == o[9] ? c ? 0 : t.length : xo(o[9] - a, 0), !f && 24 & n && (n &= -25), ri((h ? Ko : ti)(n && 1 != n ? 8 == n || 16 == n ? Nr(t, n, f) : 32 != n && 33 != n || u.length ? qr.apply(P, o) : Yr(t, n, r, e) : Dr(t, n, r), o), t, n);
      }
      ...
      function Ne(t, n, r) {
        var e = -1,
            ...
            o = u.length,
            i = o - 1;
        for (n = (r ? de(t, n, r) : n === P) ? 1 : vn(hu(n), 0, o); ++e < n; )
      ...
      (ko && "[object DataView]" != St(new ko(new ArrayBuffer(1))) || Eo && "[object Map]" != St(new Eo) || Oo && "[object Promise]" != St(Oo.resolve()) || So && "[object Set]" != St(new So) || Io && "[object WeakMap]" != St(new Io)) && (St = function(t) {
        var n = Hu.call(t);
        if (t = (t = "[object Object]" == n ? t.constructor : P) ? ke(t) : P)
          switch (t) {
            case Uo:
      ...
      var Xo = qu ? nu : Lu,
          ...
          ai = ar(function(t) {
            var n = We(t),
                r = l(t, mr);
            return n === We(r) ? n = P : r.pop(), r.length && r[0] === t[0] ? Cn(r, P, n) : [];
          }),
          li = ar(Be),
          si = ar(function(t, n) {
            n = kn(n, 1);
          ...
          di = ar(function(t) {
            var n = We(t);
            return Xe(n) && (n = P), jr(f(t, Xe), fe(n, 2));
          }),
          yi = ar(function(t) {
            var n = We(t);
          ...
          Ii = ar(function(t, n) {
            if (null == t)
              return [];
            var r = n.length;
            return 1 < r && de(t, n[0], n[1]) ? n = [] : 2 < r && de(n[0], n[1], n[2]) && (n = [n[0]]), nr(t, kn(n, 1), []);
          }),
          Ri = lo || function() {
            return Vt.Date.now();
          },
      ...
      return It.after = function(t, n) {
        ...
        if (!u)
          return [];
        for (r && typeof r != "number" && de(t, n, r) && (r = 0, e = u), u = t.length, r = hu(r), 0 > r && (r = -r > u ? 0 : u + r), e = e === P || e > u ? u : hu(e), 0 > e && (e += u), e = r > e ? 0 : pu(e); r < e; )
          t[r++] = n;
        return t;
        ...
        var e = t ? t.length : 0;
        return e ? (r && typeof r != "number" && de(t, n, r) ? (n = 0, r = e) : (n = null == n ? 0 : hu(n), r = r === P ? e : hu(r)), sr(t, n, r)) : [];
        ...
        if (Qe(t) && (Fi(t) || typeof t == "string" || typeof t.splice == "function" || Pi(t) || He(t)))
          return !t.length;
        var n = St(t);
        ...
        if (Xo(t))
          throw new Mu("This method is not supported with core-js. Try https://github.com/es-shims.");
        return Nn(t);
      }, It.isNil = function(t) {
        return null == t;
        ...
        if (!e)
          return -1;
        var u = e;
        if (r !== P && (u = hu(r), u = (0 > u ? xo(e + u, 0) : jo(u, e - 1)) + 1), n !== n)
        ...
        r && de(t, n, r) && (n = P), t = gu(t), n = Xi({}, n, e, en), r = Xi({}, n.imports, e.imports, en);
        var u,
            o,
            i = bu(r),
            f = I(r, i),
        ...
        if (t = hu(t), 1 > t || 9007199254740991 < t)
          return [];
        var r = 4294967295,
            e = jo(t, 4294967295);
        for (n = fe(n), t -= 4294967295, e = E(e, n); ++r < t; )
          n(r);
        return e;
        ...
        if (i && (o += r.length - o), Vi(u)) {
          if (t.slice(o).search(u)) {
            var f = r;
            for (u.global || (u = $u(u.source, gu(yt.exec(u)) + "g")), u.lastIndex = 0; i = u.exec(f); )
              var c = i.index;
            r = r.slice(0, c === P ? o : c);
          }
        } else
        ...
        }, i = t.start, f = t.end, t = f - i, u = u ? f : i - 1, i = this.__iteratees__, f = i.length, c = 0, a = jo(t, this.__takeCount__), !e || 200 > o || o == t && a == t)
