...
(function(process) {
  ...
  var TableBody = function(_Component) {
    ...
    function TableBody() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(TableBody)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {selectedRows: []}, _this.handleClickAway = function() {
  ...
  TableBody.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
