...
(function(process) {
    ...
    _createClass(FloatingActionButton, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        if (nextProps.disabled !== this.props.disabled) {
          this.setState({zDepth: nextProps.disabled ? 0 : this.props.zDepth});
        }
      }
    }, {
      key: 'render',
      value: function render() {
        ...
        var children = (0, _childUtils.extendChildren)(this.props.children, {style: (0, _simpleAssign2.default)({}, styles.icon, mini && styles.iconWhenMini, iconStyle)});
  ...
  FloatingActionButton.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
