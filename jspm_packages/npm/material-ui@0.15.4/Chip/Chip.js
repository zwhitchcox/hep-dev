...
var Chip = function(_Component) {
  ...
  _createClass(Chip, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_EnhancedButton2.default, _extends({}, other, buttonEventHandlers, {
        className: className,
        containerElement: 'div',
        disableTouchRipple: true,
        disableFocusRipple: true,
        style: style
      }), avatar, _react2.default.createElement('span', {style: labelStyle}, children), deleteIcon);
    }
  }]);
  return Chip;
}(_react.Component);
