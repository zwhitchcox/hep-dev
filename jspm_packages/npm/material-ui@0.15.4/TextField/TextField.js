...
(function(process) {
  ...
  var TextField = function(_Component) {
    ...
    _createClass(TextField, [{
      ...
      value: function render() {
        ...
        if (children) {
          inputElement = _react2.default.cloneElement(children, _extends({}, inputProps, children.props, {style: (0, _simpleAssign2.default)(inputStyleMerged, children.props.style)}));
        } else {
  ...
  TextField.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
