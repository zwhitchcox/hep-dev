...
var StepLabel = function(_Component) {
  ...
  _createClass(StepLabel, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('span', _extends({style: prepareStyles((0, _simpleAssign2.default)(styles.root, style))}, other), icon && _react2.default.createElement('span', {style: prepareStyles(styles.iconContainer)}, icon), children);
    }
  }]);
  return StepLabel;
}(_react.Component);
