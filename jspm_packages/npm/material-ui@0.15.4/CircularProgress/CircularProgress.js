...
var CircularProgress = function(_Component) {
  ...
  _createClass(CircularProgress, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', _extends({}, other, {style: prepareStyles((0, _simpleAssign2.default)(styles.root, style))}), _react2.default.createElement('div', {
        ref: 'wrapper',
        style: prepareStyles((0, _simpleAssign2.default)(styles.wrapper, innerStyle))
      }, _react2.default.createElement('svg', {style: prepareStyles(styles.svg)}, _react2.default.createElement('circle', {
        ref: 'path',
...
CircularProgress.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
