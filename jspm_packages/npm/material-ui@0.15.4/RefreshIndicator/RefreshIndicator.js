    ...
    value: function renderChildren() {
      ...
      if (this.props.status !== 'ready') {
        ...
        childrenCmp = _react2.default.createElement('svg', {
          ...
          viewBox: '0 0 ' + VIEWBOX_SIZE + ' ' + VIEWBOX_SIZE
        }, _react2.default.createElement('circle', _extends({style: prepareStyles(_circleStyle.style)}, _circleStyle.attr)), _react2.default.createElement('polygon', _extends({style: prepareStyles(polygonStyle.style)}, polygonStyle.attr)));
      }
      return childrenCmp;
    }
  }, {
...
RefreshIndicator.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
