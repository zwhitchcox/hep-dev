...
var BottomNavigationItem = function BottomNavigationItem(props, context) {
  ...
  return _react2.default.createElement(_EnhancedButton2.default, _extends({}, other, {style: (0, _simpleAssign2.default)({}, styles.root, style)}), styledIcon, _react2.default.createElement('div', {style: prepareStyles(styles.label)}, label));
};
...
BottomNavigationItem.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
