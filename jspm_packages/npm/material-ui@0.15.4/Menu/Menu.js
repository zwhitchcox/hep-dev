...
(function(process) {
  ...
  function getStyles(props, context) {
    ...
    var styles = {
      ...
      selectedMenuItem: {color: muiTheme.baseTheme.palette.accent1Color}
    };
    return styles;
  }
      ...
      value: function render() {
        ...
        var newChildren = _react2.default.Children.map(filteredChildren, function(child, index) {
          ...
          if (animated) {
            ...
            childrenContainerStyles = (0, _simpleAssign2.default)({}, styles.menuItemContainer, {transitionDelay: transitionDelay + 'ms'});
          }
  ...
  Menu.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
