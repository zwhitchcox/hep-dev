...
var TimePickerDialog = function(_Component) {
  ...
  function TimePickerDialog() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(TimePickerDialog)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {open: false}, _this.handleRequestClose = function() {
      _this.dismiss();
...
TimePickerDialog.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
