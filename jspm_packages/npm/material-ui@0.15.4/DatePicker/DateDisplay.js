...
function getStyles(props, context, state) {
  ...
  var styles = {
    ...
    yearTitle: {cursor: props.disableYearSelection ? 'not-allowed' : !selectedYear ? 'pointer' : 'default'}
  };
  return styles;
}
var DateDisplay = function(_Component) {
  ...
  _createClass(DateDisplay, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', _extends({}, other, {style: prepareStyles(styles.root, style)}), _react2.default.createElement(_SlideIn2.default, {
        style: styles.year,
...
DateDisplay.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
