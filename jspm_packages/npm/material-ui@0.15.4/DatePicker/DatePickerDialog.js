...
var DatePickerDialog = function(_Component) {
  ...
  _createClass(DatePickerDialog, [{
    ...
    value: function render() {
      ...
      var styles = {
        dialogContent: {width: mode === 'landscape' ? 479 : 310},
        dialogBodyContent: {
          padding: 0,
      ...
      return _react2.default.createElement('div', _extends({}, other, {ref: 'root'}), _react2.default.createElement(Container, {
...
DatePickerDialog.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
