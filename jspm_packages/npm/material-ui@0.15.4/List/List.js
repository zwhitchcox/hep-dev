...
(function(process) {
  ...
  var _Subheader = require('../Subheader/index');
  ...
  var List = function(_Component) {
    ...
    _createClass(List, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement('div', _extends({}, other, {style: prepareStyles((0, _simpleAssign2.default)(styles.root, style))}), subheader && _react2.default.createElement(_Subheader2.default, {
  ...
  List.contextTypes = {muiTheme: _react.PropTypes.object.isRequired};
