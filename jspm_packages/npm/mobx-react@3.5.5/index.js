...
(function(process) {
  !function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require('mobx'), require('react'), require('react-dom')) : "function" == typeof define && define.amd ? define(["mobx", "react", "react-dom"], t) : "object" == typeof exports ? exports.mobxReact = t(require('mobx'), require('react'), require('react-dom')) : e.mobxReact = t(e.mobx, e.React, e.ReactDOM);
  }(this, function(e, t, r) {
    return function(e) {
      function t(n) {
        if (r[n])
      ...
      function c(e, t) {
        ...
        if (Array.isArray(e))
          return t ? O["default"].apply(null, e)(c(t)) : function(t) {
            return c(e, t);
          };
        var r = e;
      ...
      var f = r(2),
          ...
          x = t.renderReporter = new v["default"],
          j = {
              ...
              var e = this,
                  ...
                  u = function() {
                    ...
                    return o.track(function() {
                      g && (e.__$mobRenderStart = Date.now()), t = l["default"].extras.allowStateChanges(!1, n), g && (e.__$mobRenderEnd = Date.now());
                    }), t;
                  };
              this.render = a;
            },
            componentWillUnmount: function() {
              if (this.render.$mobx && this.render.$mobx.dispose(), this.__$mobxIsUnmounted = !0, g) {
                var e = o(this);
